...
<body>
  ...
  <body>
    <main>
          ...
          <table class="table">
            ...
            <tbody>
              ...
              $query = "SELECT t.transaction_id, t.client_id, t.transaction_start, t.transaction_end, t.cl_comment,t.fl_proof, uj.job_name, uj.freelancer_id, uj.job_price
                                  ...
                                  WHERE t.client_id = '$user_id' AND transaction_end IS NULL;";
          ...
          <table class="table">
            ...
            <tbody>
              ...
              $query = "SELECT t.transaction_id, t.client_id, t.transaction_start, t.transaction_end, t.cl_comment,t.fl_proof, uj.job_name, uj.freelancer_id, uj.job_price
                                  FROM transactions t
                                  JOIN user_jobs uj ON t.job_id = uj.job_id
                                  WHERE t.client_id = '$user_id' AND transaction_end IS NOT NULL;";
      ...
      <section class="total-counter">
        ...
        $query = "SELECT SUM(uj.job_price) as total_earnings
              FROM transactions t
              JOIN user_jobs uj ON t.job_id = uj.job_id
              WHERE t.client_id = '$user_id' AND t.transaction_end IS NOT NULL;";
    ...
    $(document).on('submit', '#hireJob', function(e) {
      ...
      $.ajax({
        type: "POST",
        url: "/freelipino/controller/upload_clproof_controller.php",
        data: formData,
        processData: false,
        contentType: false,
